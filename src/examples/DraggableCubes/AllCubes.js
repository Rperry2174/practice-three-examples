...
class AllCubes extends React.Component {
  ...
  constructor(props, context) {
    ...
    cubePositions[1] = new THREE.Vector3(
      0,
      0,
      200
    );
    cubePositions[2] = new THREE.Vector3(
      200,
      0,
      0
    );

    cubePositions[3] = new THREE.Vector3(
      200,
      0,
      200
    );
  ...
  componentDidMount() {
    ...
    console.log("logging thisasdf asfsd f", this.directionalLightPosition)
  }
